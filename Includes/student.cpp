...
// Constructor
    Student::Student(){
            ...
            studentAge = -1;
            daysToCompletion[0] = {-1};
            daysToCompletion[1] = {-1};
    ...
    Student::Student(string cstudentID, string cfirstName, string clastName, string cstudentEmail, int cstudentAge
        ...
        this->daysToCompletion[0] = {cdaysToCompletion1};
        this->daysToCompletion[1] = {cdaysToCompletion2};
        this->daysToCompletion[2] = {cdaysToCompletion3};
